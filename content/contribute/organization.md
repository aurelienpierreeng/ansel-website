...
Developers who need help, an introduction to the code base, or code reviews can ask on the [developer Matrix chat](https://matrix.to/#/#ansel-dev:matrix.org) or in [GitHub Discussions](https://github.com/aurelienpierreeng/ansel/discussions); mentorship is offered within the maintainer's capacity.

#### Releases and stability

A stable release is a finished functional set, not a date: versions ship when what they
promise works, and the [triage rules](./triaging.md) define what lands in the next minor or
...
help stabilize a release test the `candidate` branch beforehand ([validation](./design.md)),
...
They can be discussed in [GitHub Discussions](https://github.com/aurelienpierreeng/ansel/discussions) or the [Matrix chats](https://app.element.io/#/room/#ansel:matrix.org), especially to confirm that they are actually bugs (and not design changes).

Opening issues on Github is important to include them to the project management and track them from a single place.

{{< note >}}
More details : read [a culture of problem solving](./problem-solving.md).
{{</ note >}}
...
1. Video tutorials are published and indexed from the [workflows section](../workflows/),
1. Educational long-form writing belongs on the [website](./website) or in [GitHub Discussions](https://github.com/aurelienpierreeng/ansel/discussions),
