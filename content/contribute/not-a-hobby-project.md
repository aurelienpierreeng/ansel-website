---
title: Ansel is not a hobby project
date: 2024-03-17
draft: true
authors:
    - Aurélien Pierre
...
*Originally published on the Ansel community forum, retired in 2026. Kept as historical draft: the argument now lives, updated with the current maintainer's funding channels, on the [Donate](../donate.md) page.*
...
Ansel was forked from Darktable 4.0 when its development effort dispersed into peripheral features whose cost — in maintenance, in usability, in working conditions — nobody was accounting for.
