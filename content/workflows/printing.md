...
{{<figure src="/en/workflows/img/sRGB-to-printer-zones.png" caption="The tonemapping problem from digital sRGB to a 50:1 contrast paper, as shown by Filmic zone system graph" />}}

Let's see the difference it makes on a real image having a lot of content in deep shadows :

{{<figure src="/en/workflows/img/Shooting Minh Ly-0155-_DSC0155-Minh-Ly-resized.jpg" caption="Digital original" />}}
...
{{<figure src="/en/workflows/img/sRGB-to-printer-curve.png" caption="Filmic black point compensation curve (log scale)" />}}
