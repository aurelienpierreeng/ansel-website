...
thumbnail: "/workflows/scene-referred/hero-scene-referred.fr.svg"
...
{{< figure src="./display-transform.fr.png" caption="Une courbe en « S » typique utilisée communément pour les transformations écran SDR. Les 3 nœuds représentent respectivement les points noir, gris moyen et blanc. La diagonale sombre dans l'arrière-plan est la ligne de « non-opération », ce qui veut dire que les pixels auront les mêmes valeurs RVB après la transformation qu'avant." width="600" class="float-start">}}
